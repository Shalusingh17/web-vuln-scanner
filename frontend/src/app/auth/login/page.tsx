...
function GoogleIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" aria-hidden="true" className="mr-2">
        ...
        <div className="relative overflow-hidden rounded-2xl glass-lg p-8 cyber-border-glow md:p-10">
          ...
          <div className="flex flex-col gap-3 mb-6">
            <button
              ...
              className="flex w-full items-center justify-center rounded-lg border border-slate-700 bg-slate-800/50 px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-slate-700/50 disabled:opacity-50"
            >
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs uppercase font-mono tracking-wider">
              <span className="bg-slate-900/80 px-2 text-cyan-500/70">
                Or continue with
              </span>
            </div>
          </div>
